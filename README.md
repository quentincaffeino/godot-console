...
- Change the amount of saved commands in the history. (change in `Console.gd` at Line 30) `30:var History = preload('Misc/History.gd').new(**10**) setget _set_protected)
